...
<br />
<br />
It is also not completly offline since the relationships between the entries arent exposed through exhentai. Thats why it is fetching this data from hitomi.la
<br />
<br />
## Setup:
```
